...
public class UsuariosBean implements Serializable {
    ...
    public void setUsuarioEdit(Usuario usr){
        
       usuario = usr;
        

        if(usuarioFacade.findUsuario(usuario) != null)
            usuarioFacade.removeUsuario(usuario);
        usuarioFacade.saveUsuario(usuario);
    ...
    public void eliminarReservacion(Usuario usr){
