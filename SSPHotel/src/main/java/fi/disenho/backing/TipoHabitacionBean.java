...
public class TipoHabitacionBean implements Serializable {
    ...
    public void setTipoHabitacionEdit(TipoHabitacion th){
        
       tipoHabitacion = th;
        

        if(tipoHabitacionFacade.findTipoHabitacion(tipoHabitacion) != null)
            tipoHabitacionFacade.removeTipoHabitacion(tipoHabitacion);
        tipoHabitacionFacade.saveTipoHabitacion(tipoHabitacion);
    ...
    public void eliminarReservacion(TipoHabitacion th){
