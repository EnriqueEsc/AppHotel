...
public class HuespedBean implements Serializable {
    ...
    public void setHuespedEdit(Huesped hspd){
        
       huesped = hspd;
        

        if(huespedFacade.findHuesped(huesped) != null)
            huespedFacade.removeHuesped(huesped);
        huespedFacade.saveHuesped(huesped);
    ...
    public void eliminarHuesped(Huesped hspd){
