...
public class HuespedRegistroFacade implements HuespedRegistroFacadeLocal {
    ...
    @Override
    public HuespedRegistro findHuespedRegistro(String id){
        Query query = em.createNamedQuery("HuespedRegistro.findByIdhr");
        query.setParameter("idhr",id);
        
        try{
             return (HuespedRegistro)query.getSingleResult();
